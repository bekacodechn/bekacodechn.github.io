...
var INFINITY$2 = 1 / 0;
var symbolProto$1 = ssrEntry.Symbol ? ssrEntry.Symbol.prototype : void 0, symbolToString = symbolProto$1 ? symbolProto$1.toString : void 0;
...
function isFunction(value) {
  if (!ssrEntry.isObject(value)) {
    return false;
  }
  var tag = ssrEntry.baseGetTag(value);
  return tag == funcTag$1 || tag == genTag || tag == asyncTag || tag == proxyTag;
}
var coreJsData = ssrEntry.root["__core-js_shared__"];
...
function baseIsNative(value) {
  if (!ssrEntry.isObject(value) || isMasked(value)) {
    return false;
  }
...
var WeakMap2 = getNative(ssrEntry.root, "WeakMap");
...
function baseIsArguments(value) {
  return ssrEntry.isObjectLike(value) && ssrEntry.baseGetTag(value) == argsTag$2;
}
...
var isArguments = baseIsArguments(function() {
  ...
  return ssrEntry.isObjectLike(value) && hasOwnProperty$6.call(value, "callee") && !propertyIsEnumerable$1.call(value, "callee");
};
...
var Buffer2 = moduleExports$1 ? ssrEntry.root.Buffer : void 0;
...
function baseIsTypedArray(value) {
  return ssrEntry.isObjectLike(value) && isLength(value.length) && !!typedArrayTags[ssrEntry.baseGetTag(value)];
}
...
var freeProcess = moduleExports && ssrEntry.freeGlobal.process;
...
function isKey(value, object) {
  ...
  var type = typeof value;
  if (type == "number" || type == "symbol" || type == "boolean" || value == null || ssrEntry.isSymbol(value)) {
    return true;
  }
...
var Map = getNative(ssrEntry.root, "Map");
const Map$1 = Map;
...
function toKey(value) {
  if (typeof value == "string" || ssrEntry.isSymbol(value)) {
    return value;
  }
  var result = value + "";
...
var DataView = getNative(ssrEntry.root, "DataView");
const DataView$1 = DataView;
var Promise$1 = getNative(ssrEntry.root, "Promise");
const Promise$2 = Promise$1;
var Set = getNative(ssrEntry.root, "Set");
const Set$1 = Set;
...
var getTag = ssrEntry.baseGetTag;
if (DataView$1 && getTag(new DataView$1(new ArrayBuffer(1))) != dataViewTag$1 || Map$1 && getTag(new Map$1()) != mapTag$1 || Promise$2 && getTag(Promise$2.resolve()) != promiseTag || Set$1 && getTag(new Set$1()) != setTag$1 || WeakMap$1 && getTag(new WeakMap$1()) != weakMapTag) {
  getTag = function(value) {
    var result = ssrEntry.baseGetTag(value), Ctor = result == objectTag$1 ? value.constructor : void 0, ctorString = Ctor ? toSource(Ctor) : "";
    if (ctorString) {
      switch (ctorString) {
...
var Uint8Array2 = ssrEntry.root.Uint8Array;
...
var symbolProto = ssrEntry.Symbol ? ssrEntry.Symbol.prototype : void 0, symbolValueOf = symbolProto ? symbolProto.valueOf : void 0;
...
function baseIsEqual(value, other, bitmask, customizer, stack) {
  ...
  if (value == null || other == null || !ssrEntry.isObjectLike(value) && !ssrEntry.isObjectLike(other)) {
...
function isStrictComparable(value) {
  return value === value && !ssrEntry.isObject(value);
}
...
class PageSearcher {
  ...
  async init(options = {}) {
    ...
    __privateSet(this, _index, FlexSearch__default.default.create(createOptions));
    __privateSet(this, _cjkIndex, FlexSearch__default.default.create({
      ...createOptions,
      encode: false,
      tokenize(str) {
        const cjkWords = [];
  ...
  for (const [index, header] of headers.entries()) {
    if (header.includes(query)) {
      ...
      matchedResult.push({
        ...
        link: `${ssrEntry.normalizeHref(item.path)}#${headerAnchor}`
      });
      return true;
    }
  }
...
matchContent_fn = function(item, query, matchedResult) {
  ...
  matchedResult.push({
    ...
    link: `${ssrEntry.normalizeHref(item.path)}#${currentHeader}`
  });
};
...
exports.PageSearcher = PageSearcher;
